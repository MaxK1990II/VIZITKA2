  ...
  return (
    <section className="py-24 md:py-32 px-4">
      <div className="container mx-auto text-center">
        <motion.h2
          className="js-vision-title text-3xl md:text-4xl font-bold mb-6"
        ...
        <motion.a
          href="#contact"
          className="js-vision-cta inline-block bg-cyan-500 text-white font-bold py-4 px-10 rounded-lg hover:bg-cyan-600 transition-colors"
